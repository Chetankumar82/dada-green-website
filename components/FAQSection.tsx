...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We work with industry leaders including Olectra, Evey Trans, GSRTC, and Varde Mobility to support EV fleet operations, maintenance manpower, and sustainable transit projects.",
  },
  {

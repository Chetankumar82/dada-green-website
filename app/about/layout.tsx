...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Dada Green E-Mobility LLP, our co-founders Mrs. Rinaben Chaudhari & Mr. Ajaybhai Chaudhari, our 600+ workforce, and our operational depots across Gujarat & Maharashtra.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Headquartered in Mansa (Gujarat), Dada Green powers zero-emission transit with 600+ skilled personnel across Gujarat and Maharashtra.",
